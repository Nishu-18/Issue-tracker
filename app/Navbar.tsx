...
const Navbar = () => {
  ...
  return (
   <nav className='flex space-x-6 border-b   px-5 h-14 items-center justify-between'>
    ...
    <Flex gap={"3"} align={"center"}>
        <div>
            <a className='relative group inline-block'  target='_blank' href="https://github.com/Nishu-18/Issue-tracker"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50">
...
<span className='absolute left-1/2 -translate-x-1/2 m px-4 py-1 text-sm text-white bg-slate-500 rounded-md opacity-0 group-hover:opacity-100 transition z-10'>
Open Source
</span></a>
